...
<%
	...
	*/
	...
	//System.out.println(pageContext.getAttribute("num")); //100
	
	/* 	
	
	**서버 쪽 > 페이지 간의 데이터 전달할 때 필수 사항**
	...
	*/
	...
	//System.out.println(request.getAttribute("num")); //200
